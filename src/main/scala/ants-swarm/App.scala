...
object App:
    def main(args: Array[String]): Unit = 
        ...
        val ants: Set[Ant] = Set(
            ...
            Ant(9, Position(8, 3), Direction.North, Position(0, 0)),
            Ant(10, Position(7, 3), Direction.North, Position(0, 0)),
            Ant(11, Position(6, 3), Direction.North, Position(0, 0)),
            Ant(12, Position(5, 3), Direction.North, Position(0, 0)),
